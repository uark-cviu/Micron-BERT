...
## Testing
We provide the pretrained Micron-BERT model [here](https://huggingface.co/uark-cviu/micron-bert/resolve/main/CASME2-is224-p8-b16-ep200.pth). To finetune the Micron-BERT on your micro-expression database, please refer to [micron_bert.py](micron_bert.py)
